package org.ecommerce.config.web.models.datatables;
...
public class FilterProduct implements Serializable {
	...
	public String toString() {
		return "FilterProduct{" + "id=" + id + ", name=" + name + ", priceFrom=" + priceFrom + ", priceTo=" + priceTo
				+ ", createdFrom=" + createdFrom + ", createTo=" + createTo + ", status=" + status + '}';
	}
