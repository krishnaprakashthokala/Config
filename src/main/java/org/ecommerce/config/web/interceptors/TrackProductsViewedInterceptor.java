package org.ecommerce.config.web.interceptors;

import java.util.Map;
import javax.servlet.http.HttpServletRequest;
import javax.servlet.http.HttpServletResponse;

import org.ecommerce.config.web.services.RecommenderService;
...
public class TrackProductsViewedInterceptor extends HandlerInterceptorAdapter {
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
		...
		try {
			...
			Long productLine = Long.valueOf(pathVariables.get("line"));
