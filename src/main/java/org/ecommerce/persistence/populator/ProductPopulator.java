...
public class ProductPopulator implements Serializable {
    ...
    public static boolean booleanprod= true;

	@Order(value = 4)
	// @DependsOn("productCateComp")
	...
	public void contextRefreshedEvent() {
		...
		product.setShortDescription(
				"Las zapatillas de running Nike Air Max 2017 para hombre, diseñadas a la perfección con la sujeción y la transpirabilidad .");
		product.setDescription(
				"Las zapatillas de running Nike Air Max 2017 para hombre, diseñadas a la perfección con la sujeción y la transpirabilidad adecuadas donde más lo necesitas, cuentan con una parte superior Flymesh que se combina con la suave amortiguación de la unidad Max Air de longitud completa.");
		...
		review.setBody(
				"I would never recommend these to anyone, where i have always been happy with nike shoes the quality of these was so bad.");
		...
		product2.setShortDescription(
				"Las ligeras zapatillas de entrenamiento Nike Metcon DSX Flyknit para hombre son perfectas para tus entrenamientos más exigentes.");
		product2.setDescription(
				"Las ligeras zapatillas de entrenamiento Nike Metcon DSX Flyknit para hombre son perfectas para tus entrenamientos más exigentes, desde ejercicios de pared a escalada de cuerdas o sprints y levantamiento de pesas.");
		...
		product3.setShortDescription(
				"La sudadera con gráfico Nike Sportswear Modern para mujer presenta un diseño ergonómico para un movimiento natural.");
		...
		product5.setShortDescription(
				"El polo de tenis NikeCourt Roger Federer Advantage para hombre proporciona una mayor transpirabilidad en toda la superficie.");
		product5.setDescription(
				"El polo de tenis NikeCourt Roger Federer Advantage para hombre proporciona una mayor transpirabilidad en toda la superficie para ayudar a mantenerte fresco.");
		...
		product6.setDescription(
				"Con un ajuste actualizado más ceñido y una comodidad fresca, el polo de tenis gráfico NikeCourt Advantage Premier para hombre te ayuda a centrarte en el rendimiento.");
		...
		product7.setShortDescription(
				"La camiseta NikeCourt Roger Federer para hombre está confeccionada con un tejido puro de algodón que ofrece una comodidad duradera para dentro y fuera de la pista.");
		...
		product8.setShortDescription(
				"La camiseta de tirantes de tenis NikeCourt Dry para hombre ayuda a mantenerte fresco y cómodo durante los entrenamientos más intensos.");
		...
		product9.setShortDescription(
				"La camiseta NikeCourt Heritage Logo para hombre está confeccionada con un tejido de algodón puro para ofrecer durabilidad y una mayor comodidad durante todo el día.");
		...
		product11.setShortDescription(
				"La camiseta NikeCourt Rafael Nadal para hombre está confeccionada con tejido puro de algodón que ofrece una comodidad duradera para dentro y fuera de la pista.");
